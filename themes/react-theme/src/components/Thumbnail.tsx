...
export default function Thumbnail({ logo, description, organization, title }: ThumbnailProps) {
  ...
  return (
    <div ref={wrapperRef} style={wrapperStyle} className="max-w-2xl w-full mx-auto overflow-hidden rounded-md border">
      <div
        ref={artRef}
        style={{
          width: 640,
      ...
      >
        ...
        <div className="absolute flex items-center left-12 right-12 top-12 gap-3">
          <img alt={organization} src={logo} className="object-cover object-center shrink-0 rounded-md size-8" />
